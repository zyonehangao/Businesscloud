...
import com.cloud.shangwu.businesscloud.im.db.QbUsersDbManager;
import com.cloud.shangwu.businesscloud.im.ui.fragments.AudioConversationFragment;
import com.cloud.shangwu.businesscloud.im.ui.fragments.BaseConversationFragment;
import com.cloud.shangwu.businesscloud.im.ui.fragments.ConversationFragmentCallbackListener;
import com.cloud.shangwu.businesscloud.im.ui.fragments.IncomeCallFragment;
import com.cloud.shangwu.businesscloud.im.ui.fragments.IncomeCallFragmentCallbackListener;
import com.cloud.shangwu.businesscloud.im.ui.fragments.OnCallEventsController;
import com.cloud.shangwu.businesscloud.im.ui.fragments.ScreenShareFragment;
import com.cloud.shangwu.businesscloud.im.ui.fragments.VideoConversationFragment;
import com.cloud.shangwu.businesscloud.im.utils.Consts;
import com.cloud.shangwu.businesscloud.im.utils.FragmentExecuotr;
import com.cloud.shangwu.businesscloud.im.utils.NetworkConnectionChecker;
import com.cloud.shangwu.businesscloud.im.utils.PermissionsChecker;
import com.cloud.shangwu.businesscloud.im.utils.RingtonePlayer;
import com.cloud.shangwu.businesscloud.im.utils.SettingsUtil;
import com.cloud.shangwu.businesscloud.im.utils.UsersUtils;
...
//            we have already currentSession == null, so it's no reason to do further initialization
    ...
    private void startScreenSharing(final Intent data){
        ...
        FragmentExecuotr.addFragmentWithBackStack(getSupportFragmentManager(), R.id.container, screenShareFragment, ScreenShareFragment.TAG);
...
//            });
            ...
            public void run() {
                if (show) {
                    ...
                    if (connectionView.getParent() == null) {
                        ((ViewGroup) CallActivity.this.findViewById(R.id.container)).addView(connectionView);
                    }
                } else {
                    ((ViewGroup) CallActivity.this.findViewById(R.id.container)).removeView(connectionView);
                }
            }
        });
    ...
    private void addIncomeCallFragment() {
        ...
        if (currentSession != null) {
            ...
            FragmentExecuotr.addFragment(getSupportFragmentManager(), R.id.container, fragment, INCOME_CALL_FRAGMENT);
        } else {
    ...
    private void addConversationFragment(boolean isIncomingCall) {
        BaseConversationFragment conversationFragment = BaseConversationFragment.newInstance(
                ...
                isIncomingCall);
        FragmentExecuotr.addFragment(getSupportFragmentManager(), R.id.container, conversationFragment, conversationFragment.getClass().getSimpleName());
    }
