...
public class ChatsActivity extends BaseActivity implements OnImagePickedListener {
...
//        Log.v(TAG ,"currentchat="+QBChatService.getInstance().getGroupChatManager().getGroupChat());
        initViews();
    ...
    private class ImageAttachClickListener implements QBChatAttachClickListener {
        ...
        public void onLinkClicked(QBAttachment qbAttachment, int position) {
            AttachmentImageActivity.start(ChatsActivity.this, qbAttachment.getUrl());
        }
    }
