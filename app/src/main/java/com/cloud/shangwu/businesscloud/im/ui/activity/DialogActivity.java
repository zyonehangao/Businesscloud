...
import com.cloud.shangwu.businesscloud.im.ui.adapter.DialogsAdapter;
...
import com.cloud.shangwu.businesscloud.im.utils.qb.callback.QBPushSubscribeListenerImpl;
import com.cloud.shangwu.businesscloud.im.utils.qb.callback.QbEntityCallbackImpl;
...
public class DialogActivity extends BaseActivity implements DialogsManager.ManagingDialogsCallbacks {
...
//        setActionBarTitle(getString(R.string.dialogs_logged_in_as, currentUser.getFullName()));
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == REQUEST_SELECT_PEOPLE) {
                ...
                if (isPrivateDialogExist(selectedUsers)) {
                    ...
                    ChatsActivity.startForResult(DialogActivity.this, REQUEST_DIALOG_ID_FOR_UPDATE, existingPrivateDialog);
                } else {
                ...
                if (data != null) {
                    String dialogId = data.getStringExtra(ChatsActivity.EXTRA_DIALOG_ID);
    ...
    private void userLogout() {
        ...
        LoginActivity.start(DialogActivity.this);
    ...
    private void logout() {
        if (QBPushManager.getInstance().isSubscribedToPushes()) {
            ...
            SubscribeService.unSubscribeFromPushes(DialogActivity.this);
        } else {
            logoutREST();
        }
    }
        ...
        dialogsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (currentActionMode == null) {
                    ChatsActivity.startForResult(DialogActivity.this, REQUEST_DIALOG_ID_FOR_UPDATE, selectedDialog);
                } else {
        ...
        ChatHelper.getInstance().createDialogWithSelectedUsers(selectedUsers,
                new QBEntityCallback<QBChatDialog>() {
                    ...
                    public void onSuccess(QBChatDialog dialog, Bundle args) {
                        ...
                        ChatsActivity.startForResult(DialogActivity.this, REQUEST_DIALOG_ID_FOR_UPDATE, dialog);
                        ProgressDialogFragment.hide(getSupportFragmentManager());
                    }
