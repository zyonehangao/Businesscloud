...
public class VoicePlayClickListener implements View.OnClickListener {
    ...
    public void stopPlayVoice() {
        ...
        if (stopPlayingDrawableId != 0) {
            ...
            voiceIconView.setImageResource(com.ilike.voicerecorder.R.drawable.ease_chatto_voice_playing);
        }
    ...
    private void showAnimation() {
        ...
        if (!isSetingPlayingIcon) {
             ...
             * 使用外部设置进来的播放语音的动画
             */
            voiceIconView.setImageResource(com.ilike.voicerecorder.R.drawable.voice_to_icon);
        }
    ...
    public void onClick(View v) {
        String st = activity.getResources().getString(com.ilike.voicerecorder.R.string.Is_download_voice_click_later);
        if (isPlaying) {
            if (playMsgId != null) {
                currentPlayListener.stopPlayVoice();
                return;
