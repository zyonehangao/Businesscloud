...
public class VoiceRecorderView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(com.ilike.voicerecorder.R.layout.ease_widget_voice_recorder, this);

        micImage = (ImageView) findViewById(com.ilike.voicerecorder.R.id.mic_image);
        recordingHint = (TextView) findViewById(com.ilike.voicerecorder.R.id.recording_hint);
        ...
        //默认提示语
        release_to_cancel = context.getString(com.ilike.voicerecorder.R.string.release_to_cancel);
        move_up_to_cancel = context.getString(com.ilike.voicerecorder.R.string.move_up_to_cancel);
                ...
                if (event.getY() < 0) {
                    ...
                    try {
                        ...
                        if (length > 0) {
                            ...
                            Toast.makeText(context, com.ilike.voicerecorder.R.string.Recording_without_permission, Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(context, com.ilike.voicerecorder.R.string.The_recording_time_is_too_short, Toast.LENGTH_SHORT).show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
    ...
    public void startRecording() {
        if (!CommonUtils.isSdcardExist()) {
            Toast.makeText(context, com.ilike.voicerecorder.R.string.Send_voice_need_sdcard_support, Toast.LENGTH_SHORT).show();
            return;
        }
        try {
            wakeLock.acquire();
            this.setVisibility(View.VISIBLE);
            recordingHint.setText(context.getString(com.ilike.voicerecorder.R.string.move_up_to_cancel));
            ...
            Toast.makeText(context, com.ilike.voicerecorder.R.string.recoding_fail, Toast.LENGTH_SHORT).show();
            return;
        }
    }
    ...
    public void showReleaseToCancelHint() {
       /* recordingHint.setText(context.getString(R.string.release_to_cancel));
        ...
        recordingHint.setBackgroundResource(com.ilike.voicerecorder.R.drawable.ease_recording_text_hint_bg);
    }
