...
public class FloatingSearchView extends FrameLayout {
    ...
    private final static String TAG = com.arlib.floatingsearchview.FloatingSearchView.class.getSimpleName();
     ...
     * following calls to {@link com.arlib.floatingsearchview.FloatingSearchView#swapSuggestions(List)}
     */
    ...
    private void init(AttributeSet attrs) {
        ...
        mSearchProgress = (ProgressBar) findViewById(com.arlib.floatingsearchview.R.id.search_bar_search_progress);
        initDrawables();
        mClearButton.setImageDrawable(mIconClear);
        mMenuView = (MenuView) findViewById(com.arlib.floatingsearchview.R.id.menu_view);

        mDivider = findViewById(com.arlib.floatingsearchview.R.id.divider);

        mSuggestionsSection = (RelativeLayout) findViewById(com.arlib.floatingsearchview.R.id.search_suggestions_section);
        mSuggestionListContainer = findViewById(com.arlib.floatingsearchview.R.id.suggestions_list_container);
        mSuggestionsList = (RecyclerView) findViewById(com.arlib.floatingsearchview.R.id.suggestions_list);
    ...
    private void initDrawables() {
        ...
        mIconClear = Util.getWrappedDrawable(getContext(), com.arlib.floatingsearchview.R.drawable.ic_clear_black_24dp);
        mIconBackArrow = Util.getWrappedDrawable(getContext(), com.arlib.floatingsearchview.R.drawable.ic_arrow_back_black_24dp);
        mIconSearch = Util.getWrappedDrawable(getContext(), com.arlib.floatingsearchview.R.drawable.ic_search_black_24dp);
    }
    ...
    private void applyXmlAttributes(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, com.arlib.floatingsearchview.R.styleable.FloatingSearchView);

        try {

            int searchBarWidth = a.getDimensionPixelSize(
                    com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_searchBarWidth,
            ...
            int searchBarLeftMargin = a.getDimensionPixelSize(
                    com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_searchBarMarginLeft,
                    ATTRS_SEARCH_BAR_MARGIN_DEFAULT);
            int searchBarTopMargin = a.getDimensionPixelSize(
                    com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_searchBarMarginTop,
                    ATTRS_SEARCH_BAR_MARGIN_DEFAULT);
            int searchBarRightMargin = a.getDimensionPixelSize(
                    com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_searchBarMarginRight,
                    ATTRS_SEARCH_BAR_MARGIN_DEFAULT);
            ...
            setQueryTextSize(a.getDimensionPixelSize(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_searchInputTextSize,
                    ATTRS_QUERY_TEXT_SIZE_SP_DEFAULT));
            setSearchHint(a.getString(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_searchHint));
            setShowSearchKey(a.getBoolean(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_showSearchKey,
                    ATTRS_SEARCH_BAR_SHOW_SEARCH_KEY_DEFAULT));
            setCloseSearchOnKeyboardDismiss(a.getBoolean(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_close_search_on_keyboard_dismiss,
                    ATTRS_DISMISS_ON_KEYBOARD_DISMISS_DEFAULT));
            setDismissOnOutsideClick(a.getBoolean(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_dismissOnOutsideTouch,
                    ATTRS_DISMISS_ON_OUTSIDE_TOUCH_DEFAULT));
            setDismissFocusOnItemSelection(a.getBoolean(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_dismissFocusOnItemSelection,
                    ATTRS_DISMISS_FOCUS_ON_ITEM_SELECTION_DEFAULT));
            setSuggestionItemTextSize(a.getDimensionPixelSize(
                    com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_searchSuggestionTextSize,
                    Util.spToPx(ATTRS_SUGGESTION_TEXT_SIZE_SP_DEFAULT)));
            //noinspection ResourceType
            mLeftActionMode = a.getInt(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_leftActionMode,
                    ATTRS_SEARCH_BAR_LEFT_ACTION_MODE_DEFAULT);
            if (a.hasValue(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_menu)) {
                mMenuId = a.getResourceId(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_menu, -1);
            }
            setDimBackground(a.getBoolean(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_dimBackground,
                    ATTRS_SHOW_DIM_BACKGROUND_DEFAULT));
            setShowMoveUpSuggestion(a.getBoolean(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_showMoveSuggestionUp,
                    ATTRS_SHOW_MOVE_UP_SUGGESTION_DEFAULT));
            this.mSuggestionSectionAnimDuration = a.getInt(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_suggestionsListAnimDuration,
                    ATTRS_SUGGESTION_ANIM_DURATION_DEFAULT);
            setBackgroundColor(a.getColor(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_backgroundColor
                    , Util.getColor(getContext(), com.arlib.floatingsearchview.R.color.background)));
            ...
            setDividerColor(a.getColor(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_dividerColor
                    , Util.getColor(getContext(), com.arlib.floatingsearchview.R.color.divider)));
            setClearBtnColor(a.getColor(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_clearBtnColor
                    , Util.getColor(getContext(), com.arlib.floatingsearchview.R.color.clear_btn_color)));
            int viewTextColor = a.getColor(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_viewTextColor
                    , Util.getColor(getContext(), com.arlib.floatingsearchview.R.color.dark_gray));
            setViewTextColor(viewTextColor);
            setQueryTextColor(a.getColor(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_viewSearchInputTextColor
                    , viewTextColor));
            setSuggestionsTextColor(a.getColor(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_viewSuggestionItemTextColor
                    , viewTextColor));
            setHintTextColor(a.getColor(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_hintTextColor
                    , Util.getColor(getContext(), com.arlib.floatingsearchview.R.color.hint_color)));
            setSuggestionRightIconColor(a.getColor(com.arlib.floatingsearchview.R.styleable.FloatingSearchView_floatingSearch_suggestionRightIconColor
                    , Util.getColor(getContext(), com.arlib.floatingsearchview.R.color.gray_active_icon)));
        } finally {
            a.recycle();
        }
    }
...
//                    setSearchFocusedInternal(false);
    ...
    public void setSearchHint(String searchHint) {
        mSearchHint = searchHint != null ? searchHint : getResources().getString(com.arlib.floatingsearchview.R.string.abc_search_hint);
